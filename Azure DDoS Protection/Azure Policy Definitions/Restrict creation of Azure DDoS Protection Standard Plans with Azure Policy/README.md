...
<li>In the <strong>Policy Rule</strong> section, enter the code located in the AzurePolicyRuleDenyDDoSplan.json file [here](https://github.com/Azure/Azure-Network-Security/blob/master/Azure DDoS Protection/Azure Policy Definitions/Restrict creation of Azure DDoS Protection Standard Plans with Azure Policy/AzurePolicyRuleDenyDDoSPlan.json) </li>
