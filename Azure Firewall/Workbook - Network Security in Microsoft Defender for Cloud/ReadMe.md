...
During the deployment, you must select a subscription and resource group to store the report. Once the workbook is successfully deployed, hop over to Microsoft Defender for Cloud to start using it.
