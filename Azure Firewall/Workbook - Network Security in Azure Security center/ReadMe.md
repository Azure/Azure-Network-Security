...
The new network security dashboard for Security Center provides a unified view and full visibility into your network security and networking resources in Azure. If you have been actively using Security Center and Network Security features in Azure, this workbook is for you!
...
During the deployment, you must select a subscription and resource group to store the report. Once the workbook is successfully deployed, howehop over to Security Center to start using it.
